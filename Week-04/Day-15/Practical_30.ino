// ===== Practical : Robot Dance Sequence =====
...
void setup()
{
  ...
  Serial.println("===== ROBOT DANCE SEQUENCE STARTED =====");
  Serial.println("Press SELECT Button to start dance");
}
...
void loop()
{
  ...
  // SELECT Button (931 - 932) dabane par pura dance sequence chalega
