...
#define BTN8    0xF
#define BTN9    0x19
#define BTN0    0x7   // (Mapped from RPT key)

#define OK      0x1   // (Mapped from PAUSE key)

#define UP      0x6   // (Mapped from VOL+ key)
#define DOWN    0x5   // (Mapped from VOL- key)
#define LEFT    0x2   // (Mapped from PREV key)
#define RIGHT   0x3   // (Mapped from NEXT key)
...
void setup()
{
  ...
  Serial.println("Autobotix Practical-54 Ready");
}
